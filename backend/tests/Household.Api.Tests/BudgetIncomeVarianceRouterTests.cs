...
public sealed class BudgetIncomeVarianceRouterTests
{
    ...
    {
        IReadOnlyList<IncomeVarianceAllocationResult> result = BudgetIncomeVarianceRouter.Route(10_000, BudgetValues.Fixed,
        [
    ...
    {
        IReadOnlyList<IncomeVarianceAllocationResult> result = BudgetIncomeVarianceRouter.Route(10_001, BudgetValues.Percentage,
        [
    ...
    {
        IReadOnlyList<IncomeVarianceAllocationResult> result = BudgetIncomeVarianceRouter.Route(5_000, BudgetValues.Fixed, []);

        IncomeVarianceAllocationResult allocation = Assert.Single(result);
