...
/// <summary>Accent themes the web client can render. Ids match clients/web/src/lib/theme.ts.</summary>
public static class Themes
{
    public const string Default = "mandarine";

    public static readonly IReadOnlySet<string> All = new HashSet<string>(StringComparer.Ordinal)
    {
        "mandarine", "lagune", "ozean", "farn", "heidelbeere", "himbeere", "graphit",
    };
}
