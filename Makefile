...
core-up:
	...
	docker compose --env-file $(ENV_FILE) --env-file $(ENV_FILE_DEV) -f $(INFRA_FILE) --profile core up -d

core-down:
	docker compose --env-file $(ENV_FILE) --env-file $(ENV_FILE_DEV) -f $(INFRA_FILE) --profile core down
